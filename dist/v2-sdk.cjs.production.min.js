...
var e = t(require('jsbi')),
  ...
  i = '74e715a8d098397cb81d67353045ac6ff76aad7ccfcea321c0828e63e9b358f0',
  s = e.BigInt(1e3),
  a = e.BigInt(0),
  c = e.BigInt(1),
  p = e.BigInt(5),
...
var I = 'setPrototypeOf' in Object,
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return b({ factoryAddress: '0x99dD3fDf727D469E932220e000e89B92e5971843', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        if (e.equal(m.quotient, a)) throw new O()
...
;(exports.FACTORY_ADDRESS = '0x99dD3fDf727D469E932220e000e89B92e5971843'),
